...
public partial class CreateSampleJob
{
    partial class PresentationLayer
    {
        ...
        {
            // Implement any further Presentation Code for the CreateSampleJob feature here...
    ...
    partial class ApplicationLayer
    {
        ...
        {
            // Implement any further Application Code for the CreateSampleJob feature here...
            // The application layer can only dispatch queries via clientQueries; commands are blocked at compile time.
            // ...
    ...
    partial class InfrastructureLayer
    {
        ...
        {
            // Implement any further Infrastructure Code for the CreateSampleJob feature here...
            // The infrastructure layer can only dispatch commands via clientCommands; queries are blocked at compile time.
            // ...
